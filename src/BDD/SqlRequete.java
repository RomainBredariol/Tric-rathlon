...
public class SqlRequete {
	...
	//methode qui envoie une requetre � la bdd CELLE CI N'AFFICHE QUE DANS LA CONSOLE (cf. methode suivante) 
	...
	//cette m�thode permet de demander une donn�e en particulier (ex: select nom from user where id=1)
	...
	//METHODE IMPORTANTE: Elle ferme la connexion effectu�e entre jdbc et bdd donc il faudra le faire syst�matiquement quand on utilise les methodes du dessus
